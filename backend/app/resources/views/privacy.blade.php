...
<html lang="{{ app()->getLocale() }}">
  ...
  <head>
    ...
    <title>2020 Programetic xR Native Advertisment Privacy</title>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="/images/logo/2020-logo-RGB-BW.png" width="8%" alt="2020 logo">
</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="http://20-twenty.online/#whyus" >Why us?</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="http://20-twenty.online/#features">Who we work with?</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="http://20-twenty.online/#contact">Contact</a>
            </li>
          </ul>
        </div>
        @if (Route::has('login'))
    ...
    <footer>
      <div class="container">
        <p>&copy; 2020 2018. All Rights Reserved.</p>
